...
Nueva Versión: V 0.1.2 (xx/xx/2024) [AÚN NO LIBERADA]

Notas del parche:

 - Corrección de Sprites de batalla de Linonne de Galar (estaba corrupto en cuanto a colores)
 - Rework de Sprites de Kaburu
 - La línea de Indog ahora es tipos Tierra/Normal en todas sus fases, debido a la gran cantidad de pokémon de tipo siniestro.
 - Correción definitiva de errores a cambiar de mapa.
 - Correcciones ortográficas menores.
 - Nuevo Mov: Hoja Boomerang. Físico, 30 de potencia, 100 de precisión, golea 2 veces.
 - El inicial de tipo planta (y sus evoluciones) ya NO aprenden el movimiento "Recurrente" por nivel. En su lugar, aprende un nuevo mov. llamado "Hoja Boomerang".
###########################################################################################
